...
import { getAllBookingsByAdmin, getBookingsDashboard } from "@/services/bookingServices"
...
const getBookings = async (
    ...
    try {
        if (useDashboard) {
            const dashboardData = await getBookingsDashboard()
            return {
                bookings: dashboardData.bookings,
                pagination: {
                    currentPage: 1,
                    totalPages: Math.ceil(dashboardData.pagination.cancelledBookings.total / 10),
                    totalBookings: dashboardData.metrics.totalBookings,
                    hasNextPage: dashboardData.pagination.cancelledBookings.hasMore,
                    hasPrevPage: false,
                    nextPage: dashboardData.pagination.cancelledBookings.hasMore ? 2 : null,
                    prevPage: null,
                    limit: 10,
                    skip: 0,
                },
            ...
            const bookingData = await getAllBookingsByAdmin({ page, status, paymentStatus, search, sortBy })
            return {
...
export default function BookingsDashboard() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setIsLoading(true)
                const useDashboard = isInitialLoad
                //  && !searchTerm && statusFilter === "all" && paymentStatusFilter === "all" && currentPage === 1
                ...
                if (useDashboard) {
                    const dashboardData = await getAllBookingsByAdmin({ sortBy: sortByFilter })
        ...
        fetchData()
    }, [currentPage, statusFilter, paymentStatusFilter, searchTerm, sortByFilter, isInitialLoad])
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-200">
                    <div className="flex items-center">
                        ...
                        <h2 className="text-lg font-medium">Bookings Management</h2>
                    </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-5">
                            ...
                            <Card className="border-none shadow-lg">
                                <CardHeader className="pb-2">
                                    ...
                                    <CardTitle className="text-3xl font-bold flex items-center">
                                        <CheckCircle className="h-6 w-6 text-blue-500 mr-1" />
                            ...
                            <CardHeader>
                                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                                    <div>
                                        ...
                                        <CardDescription>Manage and review stall bookings</CardDescription>
                                    </div>
