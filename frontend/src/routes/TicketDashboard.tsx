...
import { getTicketDashboard } from "@/services/ticketServices";
...
interface TicketData {
    ...
    ticketId: string;
    createdAt?: string; // Updated from submittedAt to match API response
}
...
interface TicketsResponse {
    ...
    eventTicketStats: EventTicketStats[]; // Added to match API response
}
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-200">
                    <div className="flex items-center">
                        ...
                        <h2 className="text-lg font-medium">Tickets Management</h2>
                    </div>
                            ...
                            <CardHeader>
                                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                                    <div>
                                        ...
                                        <CardDescription>Manage and review ticket submissions</CardDescription>
                                    </div>
                                                    ...
                                                    {ticketsData.tickets.map((ticket) => (
                                                        <tr key={ticket._id} className="hover:bg-gray-50">
                                                            ...
                                                            <td className="px-4 py-4">
                                                                ...
                                                                <div className="text-xs text-gray-500">ID: {ticket.eventId.substring(0, 8)}...</div>
                                                            </td>
                                                            <td className="px-4 py-4 whitespace-nowrap">
